...
// Page header as stored along with page contents in each page - page = page
...
struct FileHdr {
    int firstFreePage; // first free page in the free page linked list, i.e.
                       // head of free page linked list
...
class FileManager {
  public:
    ...
    FileHandler CreateFile(
        const char *fileName); // Create a new file and return a File handler
